...
# Load the data:
myData = read.csv("./DBDA2Eprograms/z15N50.csv") # Read data file; must be in curr. work. dir.
...
jagsModel = jags.model(
  file="TEMPmodel.txt" , data=dataList , inits=initsList ,
  n.chains=3 , n.adapt=500
)
update( jagsModel , n.iter=500 )
codaSamples = coda.samples(
  jagsModel, variable.names=c("theta"), n.iter=3334
)
