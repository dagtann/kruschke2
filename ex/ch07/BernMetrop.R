...
source(
  "/Users/dag/github/kruschke2/DBDA2Eprograms/DBDA2E-utilities.R"
)
...
likelihood = function( theta , data ) {
  ...
  # The theta values passed into this function are generated
  # at random, and therefore might be inadvertently greater
  # than 1 or less than 0. The likelihood for theta > 1 or
  # for theta < 0 is zero:
...
prior = function( theta ) {
  ...
  # The theta values passed into this function are generated
  # at random, and therefore might be inadvertently greater
  # than 1 or less than 0. The prior for theta > 1 or for
  # theta < 0 is zero:
...
# target distribution is the unnormalized posterior
# distribution.
...
burnIn = ceiling( 0.0 * trajLength ) # arbitrary number,
# less than trajLength
# Initialize accepted, rejected counters, just to monitor
# performance:
nAccepted = 0
nRejected = 0
...
# trajTail = acceptedTraj[(Lag+1):Len]
# plot(
#   trajHead, trajTail, pch = ".", col = "skyblue",
#   main = bquote(
#     list(
#       "Prpsl.SD" == .(proposalSD),
#       lag == .(Lag),
